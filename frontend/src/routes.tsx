...
export function AppRoutes({ user, onLogin, onLogout, onToast }: AppRoutesProps) {
  ...
  return (
    <div className="pageTransitionRoot" key={location.pathname}>
      <Routes>
        ...
        <Route path="/buyer/orders" element={<RoleGuard allow={["BUYER", "ADMIN"]} user={user}><Orders onLogout={onLogout} onToast={onToast} /></RoleGuard>} />
